 ...
 *
 * The mirror (jovial-axolotl-209.convex.site) serves the same app via
 ...
 * Env:   MIRROR_URL            (default https://jovial-axolotl-209.convex.site)
 ...
 */
const MIRROR_URL = (
  process.env.MIRROR_URL ?? "https://jovial-axolotl-209.convex.site"
).replace(/\/+$/, "");
