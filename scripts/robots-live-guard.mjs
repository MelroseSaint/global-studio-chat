 ...
 *     submitted.
 *   - MIRROR host (jovial-axolotl-209.convex.site): robots.txt must still
 ...
 * ROBOTS_MIRROR_URL (default https://jovial-axolotl-209.convex.site),
...
const MIRROR = (
  process.env.ROBOTS_MIRROR_URL ?? "https://jovial-axolotl-209.convex.site"
).replace(/\/+$/, "");
const EXPECTED_HOST = (
