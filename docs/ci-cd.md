...
| **Weekly ops digest** (`weekly-ops-digest.yml`) | Sundays 06:00 UTC + manual | Generates one always-current health issue: 7-day CI trends (main branch), backup age, open `prod-*` alert issues, Cloudinary quota + growth trend |
