...
| Delivery | Vercel (primary) + Convex static-hosting mirror | `purewire.vercel.app` / `jovial-axolotl-209.convex.site` |
...
Browser
  ...
  ├─ Convex cloud (jovial-axolotl-209.convex.cloud) → DB + functions + auth
  │     └─ static-hosting mirror (jovial-axolotl-209.convex.site)
