...
| `npm run qa:seo-audit` | SEO audit of the newest post + profile (claude-seo linters): absolute floor **and** a committed-score baseline — any drop > Δ (`CQ_DELTA`, default 5) fails even above the floor |
