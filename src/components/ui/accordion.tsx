  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          // INP: only the text color and the chevron rotate on interaction —
          // transition colors (the chevron has its own transition-transform)
          // instead of everything, which would animate layout per toggle.
